Slack API in Go [![Go Reference](https://pkg.go.dev/badge/github.com/MadFaill/slackv2.svg)](https://pkg.go.dev/github.com/MadFaill/slackv2)
===============
...
See [CHANGELOG.md](https://github.com/MadFaill/slackv2/blob/master/CHANGELOG.md) or [Releases](https://github.com/MadFaill/slackv2/releases) for more information about the changes.

## Installing

### *go get*

    $ go get -u github.com/MadFaill/slackv2
...
See https://github.com/MadFaill/slackv2/blob/master/examples/socketmode/socketmode.go
...
See https://github.com/MadFaill/slackv2/blob/master/examples/websocket/websocket.go


## Minimal EventsAPI usage:

See https://github.com/MadFaill/slackv2/blob/master/examples/eventsapi/events.go
